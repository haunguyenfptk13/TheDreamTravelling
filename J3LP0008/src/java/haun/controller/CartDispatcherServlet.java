...
public class CartDispatcherServlet extends HttpServlet {
    private final String REMOVE_ITEMS_SERVLET = "RemoveSelectedItemServlet";
    private final String UPDATE_CART_SERVLET = "UpdateCartServlet";
    private final String BOOKING_SERVLET = "BookingServlet";
    private final String USE_DISCOUNT_SERVLET = "UseDiscountServlet";
    /**
